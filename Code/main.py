...
range = 15 * ppm   #50 meters * pixels per meter.
print("Map Size(m): ", [3810/ppm, 2096/ppm])

laser=sensor.LaserSensor(resolution,range,enviorment.OriginalMap,uncertainty=(0.02,0.005))
...
while running:
    ...
    sensor_data = laser.senseObstacle() #Raw sensor data
...
fig.suptitle("Nominal Residual", fontsize=16)  # main title
plt.tight_layout()
